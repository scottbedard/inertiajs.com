    ...
    <>
      ...
      <Vue>
        <P>
          ...
          <A href="https://vuejs.org/api/sfc-script-setup.html#defineoptions">defineOptions</A>
          within <Code>{'<script setup>'}</Code>. Older versions of Vue can use the
          <A href="https://vuejs.org/api/sfc-script-setup.html#defineoptions">defineOptions plugin</A>:
        </P>
        <CodeBlock
          language="markup"
          children={dedent`
